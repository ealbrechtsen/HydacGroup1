...
namespace ModelPersistence.Persistence
{
    public class EmployeeRepository : IRepository<Employee>
    {
        ...
        public EmployeeRepository(DepartmentRepository DepartmentRepo)
        {
            ...
            //                departmentRepo.GetDepartment(reader["Department"].ToString())
            //            );
        ...
        public void Add(Employee employee)
        {
            ...
            {
                connection.Open();
                SqlCommand cmd = new SqlCommand("INSERT INTO EMPLOYEE(FirstName, LastName, CPRNum, PhoneNum, Email, Address, Department)"+ "VALUES(@FirstName, @LastNameCPRNum, @PhoneNum, @Email, @Address, @Department)", connection);
                ...
                cmd.Parameters.Add("@Department", SqlDbType.NVarChar).Value = employee.Department.Name;
                cmd.ExecuteNonQuery();
                employees.Add(employee);
